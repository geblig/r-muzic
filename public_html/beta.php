...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en">
   ...
   <script>
			_gaq = window._gaq || []; // ensure global so rails asset pipeline doesn't obfuscate
			_gaq.unshift(['_setAccount','UA-50401124-1'], ['_trackPageview']); //prepend before any special actions
			...
			<a title="Real Time Analytics" href="http://clicky.com/100736936"><img alt="Real Time Analytics" src="//static.getclicky.com/media/links/badge.gif" border="0" /></a>
	...
	var clicky_site_ids = clicky_site_ids || [];
			clicky_site_ids.push(100736936);
			(function() {
